...
// filter  HorrorBooks
  const HorrorBooks = allBooks.filter(book => book.category === 'Horror Books');
  return (
    <div>
      <HeaderContent/>
      <h1 className='text-center text-5xl text-yellow-300 font-serif'> Horror Books</h1>
  ...
  {HorrorBooks.map((book) => (
    <div key={book._id} className="bg-zinc-900 rounded-xl p-5  duration-300">
