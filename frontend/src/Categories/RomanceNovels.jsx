...
// filter  RomanceNovels
  const RomanceNovels = allBooks.filter(book => book.category === 'Romance Novels');
  return (
    <div>
      <HeaderContent/>
      <h1 className='text-center text-5xl text-yellow-300 font-serif'> Romance Novels</h1>
      <div className='px-4 my-12 text-white mb-8 text-5xl  '>    
      <div className=" grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-6 p-4">
  {RomanceNovels.map((book) => (
